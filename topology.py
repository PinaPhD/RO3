...
class MyTopo( Topo ):
    ...
    def build( self ):
        ...
        self.addLink(wt1_sw2, sp2, intfName1='wt1_sw2-eth3', intfName2='sp2-eth1')
        self.addLink(wt1_sw2, sp3, intfName1='wt1_sw2-eth4', intfName2='sp3-eth1')
        self.addLink(wt2_sw2, sp1, intfName1='wt2_sw2-eth2', intfName2='sp1-eth2')
        self.addLink(wt2_sw2, sp2, intfName1='wt2_sw2-eth3', intfName2='sp2-eth2')
        self.addLink(wt2_sw2, sp3, intfName1='wt2_sw2-eth4', intfName2='sp3-eth2')
        self.addLink(wt3_sw2, sp1, intfName1='wt3_sw2-eth2', intfName2='sp1-eth3')
        self.addLink(wt3_sw2, sp2, intfName1='wt3_sw2-eth3', intfName2='sp2-eth3')
        self.addLink(wt3_sw2, sp3, intfName1='wt3_sw2-eth4', intfName2='sp3-eth3')
        self.addLink(wt4_sw2, sp1, intfName1='wt4_sw2-eth2', intfName2='sp1-eth4')
        self.addLink(wt4_sw2, sp2, intfName1='wt4_sw2-eth3', intfName2='sp2-eth4')
        self.addLink(wt4_sw2, sp3, intfName1='wt4_sw2-eth4', intfName2='sp3-eth4')
        self.addLink(wt5_sw2, sp1, intfName1='wt5_sw2-eth2', intfName2='sp1-eth5')
        self.addLink(wt5_sw2, sp2, intfName1='wt5_sw2-eth3', intfName2='sp2-eth5')
        self.addLink(wt5_sw2, sp3, intfName1='wt5_sw2-eth4', intfName2='sp3-eth5')
        ...
        self.addLink(sp2, sp3, intfName1='sp2-eth7', intfName2='sp3-eth7')

        # Interface names for mesh links between spine and distribution leaf switches
        self.addLink(sp1, fs1, intfName1='sp1-eth8', intfName2='fs1-eth1')
        self.addLink(sp1, fs2, intfName1='sp1-eth9', intfName2='fs2-eth1')
        self.addLink(sp1, fs3, intfName1='sp1-eth10', intfName2='fs3-eth1')
        self.addLink(sp1, fs4, intfName1='sp1-eth11', intfName2='fs4-eth1')

        self.addLink(sp2, fs1, intfName1='sp2-eth8', intfName2='fs1-eth2')
        self.addLink(sp2, fs2, intfName1='sp2-eth9', intfName2='fs2-eth2')
        self.addLink(sp2, fs3, intfName1='sp2-eth10', intfName2='fs3-eth2')
        self.addLink(sp2, fs4, intfName1='sp2-eth11', intfName2='fs4-eth2')

        self.addLink(sp3, fs1, intfName1='sp3-eth8', intfName2='fs1-eth3')
        self.addLink(sp3, fs2, intfName1='sp3-eth9', intfName2='fs2-eth3')
        self.addLink(sp3, fs3, intfName1='sp3-eth10', intfName2='fs3-eth3')
        self.addLink(sp3, fs4, intfName1='sp3-eth11', intfName2='fs4-eth3')

        # Create mesh links between leaf switches
        self.addLink(fs1, fs5, intfName1='fs1-eth4', intfName2='fs5-eth1')
        self.addLink(fs1, fs6, intfName1='fs1-eth5', intfName2='fs6-eth1')
        self.addLink(fs1, fs7, intfName1='fs1-eth6', intfName2='fs7-eth1')
        self.addLink(fs1, fs8, intfName1='fs1-eth7', intfName2='fs8-eth1')
        self.addLink(fs1, fs9, intfName1='fs1-eth8', intfName2='fs9-eth1')
        self.addLink(fs1, fs10, intfName1='fs1-eth9', intfName2='fs10-eth1')
        self.addLink(fs1, fs11, intfName1='fs1-eth10', intfName2='fs11-eth1')
        self.addLink(fs1, fs12, intfName1='fs1-eth11', intfName2='fs12-eth1')
        self.addLink(fs1, fs13, intfName1='fs1-eth12', intfName2='fs13-eth1')
        self.addLink(fs1, fs14, intfName1='fs1-eth13', intfName2='fs14-eth1')
        self.addLink(fs1, fs15, intfName1='fs1-eth14', intfName2='fs15-eth1')
        self.addLink(fs1, fs16, intfName1='fs1-eth15', intfName2='fs16-eth1')

        self.addLink(fs2, fs5, intfName1='fs2-eth4', intfName2='fs5-eth2')
        self.addLink(fs2, fs6, intfName1='fs2-eth5', intfName2='fs6-eth2')
        self.addLink(fs2, fs7, intfName1='fs2-eth6', intfName2='fs7-eth2')
        self.addLink(fs2, fs8, intfName1='fs2-eth7', intfName2='fs8-eth2')
        self.addLink(fs2, fs9, intfName1='fs2-eth8', intfName2='fs9-eth2')
        self.addLink(fs2, fs10, intfName1='fs2-eth9', intfName2='fs10-eth2')
        self.addLink(fs2, fs11, intfName1='fs2-eth10', intfName2='fs11-eth2')
        self.addLink(fs2, fs12, intfName1='fs2-eth11', intfName2='fs12-eth2')
        self.addLink(fs2, fs13, intfName1='fs2-eth12', intfName2='fs13-eth2')
        self.addLink(fs2, fs14, intfName1='fs2-eth13', intfName2='fs14-eth2')
        self.addLink(fs2, fs15, intfName1='fs2-eth14', intfName2='fs15-eth2')
        self.addLink(fs2, fs16, intfName1='fs2-eth15', intfName2='fs16-eth2')

        self.addLink(fs3, fs5, intfName1='fs3-eth4', intfName2='fs5-eth3')
        self.addLink(fs3, fs6, intfName1='fs3-eth5', intfName2='fs6-eth3')
        self.addLink(fs3, fs7, intfName1='fs3-eth6', intfName2='fs7-eth3')
        self.addLink(fs3, fs8, intfName1='fs3-eth7', intfName2='fs8-eth3')
        self.addLink(fs3, fs9, intfName1='fs3-eth8', intfName2='fs9-eth3')
        self.addLink(fs3, fs10, intfName1='fs3-eth9', intfName2='fs10-eth3')
        self.addLink(fs3, fs11, intfName1='fs3-eth10', intfName2='fs11-eth3')
        self.addLink(fs3, fs12, intfName1='fs3-eth11', intfName2='fs12-eth3')
        self.addLink(fs3, fs13, intfName1='fs3-eth12', intfName2='fs13-eth3')
        self.addLink(fs3, fs14, intfName1='fs3-eth13', intfName2='fs14-eth3')
        self.addLink(fs3, fs15, intfName1='fs3-eth14', intfName2='fs15-eth3')
        self.addLink(fs3, fs16, intfName1='fs3-eth15', intfName2='fs16-eth3')

        self.addLink(fs4, fs5, intfName1='fs4-eth4', intfName2='fs5-eth4')
        self.addLink(fs4, fs6, intfName1='fs4-eth5', intfName2='fs6-eth4')
        self.addLink(fs4, fs7, intfName1='fs4-eth6', intfName2='fs7-eth4')
        self.addLink(fs4, fs8, intfName1='fs4-eth7', intfName2='fs8-eth4')
        self.addLink(fs4, fs9, intfName1='fs4-eth8', intfName2='fs9-eth4')
        self.addLink(fs4, fs10, intfName1='fs4-eth9', intfName2='fs10-eth4')
        self.addLink(fs4, fs11, intfName1='fs4-eth10', intfName2='fs11-eth4')
        self.addLink(fs4, fs12, intfName1='fs4-eth11', intfName2='fs12-eth4')
        self.addLink(fs4, fs13, intfName1='fs4-eth12', intfName2='fs13-eth4')
        self.addLink(fs4, fs14, intfName1='fs4-eth13', intfName2='fs14-eth4')
        self.addLink(fs4, fs15, intfName1='fs4-eth14', intfName2='fs15-eth4')
        self.addLink(fs4, fs16, intfName1='fs4-eth15', intfName2='fs16-eth4')
