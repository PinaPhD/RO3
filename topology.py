...
class MyTopo( Topo ):
    ...
    def build( self ):
        ...
        self.addLink(sp1, sp2, intfName1='sp1-eth1', intfName2='sp2-eth1')
        self.addLink(sp1, sp3, intfName1='sp1-eth2', intfName2='sp3-eth1')
        self.addLink(sp2, sp3, intfName1='sp2-eth2', intfName2='sp3-eth2')

        # Interface names for mesh links between spine and distribution leaf switches
        self.addLink(sp1, fs1, intfName1='sp1-eth3', intfName2='fs1-eth1')
        self.addLink(sp1, fs2, intfName1='sp1-eth4', intfName2='fs2-eth1')
        self.addLink(sp1, fs3, intfName1='sp1-eth5', intfName2='fs3-eth1')
        self.addLink(sp1, fs4, intfName1='sp1-eth6', intfName2='fs4-eth1')

        self.addLink(sp2, fs1, intfName1='sp2-eth3', intfName2='fs1-eth2')
        self.addLink(sp2, fs2, intfName1='sp2-eth4', intfName2='fs2-eth2')
        self.addLink(sp2, fs3, intfName1='sp2-eth5', intfName2='fs3-eth2')
        self.addLink(sp2, fs4, intfName1='sp2-eth6', intfName2='fs4-eth2')

        self.addLink(sp3, fs1, intfName1='sp3-eth3', intfName2='fs1-eth3')
        self.addLink(sp3, fs2, intfName1='sp3-eth4', intfName2='fs2-eth3')
        self.addLink(sp3, fs3, intfName1='sp3-eth5', intfName2='fs3-eth3')
        self.addLink(sp3, fs4, intfName1='sp3-eth6', intfName2='fs4-eth3')
